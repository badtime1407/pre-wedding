...
<template>
  <div class="min-h-screen bg-[#f6f8f6] py-16 px-6">
    ...
    <h1 class="text-4xl font-bold text-center mb-12">แพ็คเกจ Pre-Wedding</h1>
    ...
    >
      <div class="bg-white w-full max-w-2xl rounded-2xl shadow-2xl p-8 relative max-h-[90vh] overflow-y-auto">
        ...
        <img :src="selectedPackage.image_url" class="w-full h-72 object-cover object-[center_15%] rounded-xl mb-6"/>
